...
void UnitInfoManager::onStart()
{
	...
	m_units[sc2::Unit::Alliance::Self] = UnitV();
	m_units[sc2::Unit::Alliance::Ally] = UnitV();
	m_units[sc2::Unit::Alliance::Neutral] = UnitV();
	m_units[sc2::Unit::Alliance::Enemy] = UnitV();
}
...
{
	UnitType type = UnitType(sc2::UNIT_TYPEID::TERRAN_SUPPLYDEPOT, m_bot);
	return getUnitTypeCount(self, type);
}
